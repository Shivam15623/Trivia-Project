...
export const LazyWaitingRoom = lazy(() => import("@/Pages/Common/WaitingRoom"));
export const LazyPlayGamePage = lazy(() => import("@/Pages/Common/PlayGame"));
...
export const LazySoloGameEnd = lazy(() => import("@/Pages/Common/SoloGameEnd"));
