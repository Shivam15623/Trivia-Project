...
const variantClasses = {
  default: {
    list: "flex bg-white space-x-4 mb-2 w-fit",
    trigger:
      "text-gray-500 py-2 px-4 font-medium  text-base rounded-none shadow-none focus:outline-none",
    active:
      "py-2 px-4 font-medium text-base focus:outline-none data-[state=active]:shadow-none border-0 border-b-2 border-[#e34b4b] text-[#e34b4b]",
  },
  userprofile: {
