          ...
          style={
            {
              ...
              "--sidebar-icon-w": SIDEBAR_WIDTH_ICON,
              ...style,
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground w-[var(--sidebar-mobile-w)] p-0 [&>button]:hidden"
          style={
            {
              "--sidebar-width": "var(--sidebar-mobile-w)",
            } as React.CSSProperties
          }
          side={side}
        >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-[var(--sidebar-w)] bg-transparent transition-[width] duration-200 ease-linear",
          "group-data-[collapsible=offcanvas]:w-0",
          "group-data-[side=right]:rotate-180",
          variant === "floating" || variant === "inset"
            ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-icon-w)+(--spacing(4)))]"
            : "group-data-[collapsible=icon]:w-(--sidebar-icon-w)",
        )}
      />
      <div
        data-slot="sidebar-container"
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-[var(--sidebar-w)] transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
            ? "left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]"
            : "right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]",
          // Adjust the padding for floating and inset variants.
          variant === "floating" || variant === "inset"
            ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-icon-w)+(--spacing(4))+2px)]"
            : "group-data-[collapsible=icon]:w-(--sidebar-icon-w) group-data-[side=left]:border-r group-data-[side=right]:border-l",
          className,
        )}
        {...props}
      >
